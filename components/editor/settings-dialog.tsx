            ...
            <div className="space-y-4">
              ...
              <div className="group relative">
                ...
                <Popover open={openModel} onOpenChange={setOpenModel}>
                  <PopoverTrigger id="select-model" render={<Button size="lg" variant="outline" className="w-full justify-between" aria-expanded={openModel} role="combobox" />}><code>{tempModel.label}</code><ChevronsUpDown className="ml-2 size-4 shrink-0 opacity-50" /></PopoverTrigger>
